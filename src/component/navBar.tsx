    ...
    return (
        <nav className="navbar">
            <button className="hamburger">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="ipc-icon ipc-icon--menu ipc-responsive-button__icon" viewBox="0 0 24 24" fill="currentColor" role="presentation">
            ...
            <div className="nav-items">
                <button className="search-icon" onClick={openModal}>
